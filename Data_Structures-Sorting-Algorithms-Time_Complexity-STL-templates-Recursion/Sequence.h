...
private:
    ...
    void insertBefore(Node<ItemType>* p, const ItemType& value);
    // Insert value in a new Node before Node p, incrementing m_size.

    Node<ItemType>* doErase(Node<ItemType>* p);
    // Remove the Node p, decrementing m_size.  Return the Node that
    // followed p.

    Node<ItemType>* nodeAtPos(int pos) const;
...
Sequence<ItemType>::Sequence(const Sequence& other)
{
    ...
    for (Node<ItemType>* p = other.m_head->m_next; p != other.m_head; p = p->m_next)
...
template<class ItemType>
void Sequence<ItemType>::insertBefore(Node<ItemType>* p, const ItemType& value)
{
    // Create a new node

    Node<ItemType>* newp = new Node<ItemType>;
    newp->m_value = value;
...
template<class ItemType>
Sequence<ItemType>::Node<ItemType>* Sequence<ItemType>::doErase(Node<ItemType>* p)
{
    // Save pointer to p's successor

    Node<ItemType>* pnext = p->m_next;
...
template<class ItemType>
Sequence<ItemType>::Node<ItemType>* Sequence<ItemType>::nodeAtPos(int pos) const
{
    Node<ItemType>* p;
