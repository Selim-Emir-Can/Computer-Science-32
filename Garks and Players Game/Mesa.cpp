#include"Player.h"
#include"Gark.h"
#include"Mesa.h" // we need access to the implementation of these classes
...
Mesa::Mesa(int nRows, int nCols) // initialized the newly added history member variable in the intialization list
...
{
    switch (dir)                                                        // if gark is pushed off the edge of the mesa function returns false
    {
